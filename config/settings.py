...
# OPENROUTER_MODEL is tried first; if it's rate-limited (429) or no longer
# available (404 — OpenRouter's free-tier catalog rotates), ai.py falls back
# to each model in OPENROUTER_FALLBACK_MODELS in order.
